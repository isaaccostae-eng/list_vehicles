...
st.sidebar.header("Search filter") #adicionado cabeçalho na barra lateral
...
price_filter = st.sidebar.slider("Filter by price", min_value=min_price, max_value=max_price, value=(min_price, max_price))
